...
public class Program_5_Palindrome {
    public static void main(String[] args) {
        System.out.println("Enter number: ");
        Scanner sc = new Scanner(System.in);
        int pnumber = sc.nextInt();
        if (isPalindrome(pnumber)) {
            System.out.println("return true : " + pnumber + " is a Palindrome number ");
        } else {
            System.out.println(" return false because this number " + pnumber + " isn't looks like the same reversely");
        }
        sc.close();
    }
